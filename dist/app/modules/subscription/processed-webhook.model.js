 ...
 *
 * Uniqueness is on `(provider, webhookId)` to defend against the unlikely
 * case of a UUID/messageId collision across providers.
 */
...
processedWebhookSchema.index({ provider: 1, webhookId: 1 }, { unique: true });
