...
const createSutureToDB = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield sutures_model_1.SutureModel.create(data);
});
const updateSutureInDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteSutureFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const doc = yield sutures_model_1.SutureModel.findById(id);
    if (!doc)
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Suture not found');
...
const listSuturesFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
