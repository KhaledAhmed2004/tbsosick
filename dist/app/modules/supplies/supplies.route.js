...
// Update Supply — by ID
router.patch('/:id', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN), (0, validateRequest_1.default)(supplies_validation_1.SuppliesValidation.updateSupplySchema), supplies_controller_1.SuppliesController.updateSupply);
// Delete Supply — by ID
router.delete('/:id', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN), (0, validateRequest_1.default)(supplies_validation_1.SuppliesValidation.paramIdSchema), supplies_controller_1.SuppliesController.deleteSupply);
