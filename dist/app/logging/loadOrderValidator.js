...
exports.LoadOrderValidator = void 0;
class LoadOrderValidator {
    /**
     * Register that a stage has been loaded
     */
    static markLoaded(stage, modulePath) {
     ...
     */
    static validate(currentStage, requiredStages, currentModulePath) {
        ...
        if (missing.length > 0) {
            const error = [
                ...
                `   1. MONGOOSE_METRICS (mongooseMetrics)`,
                `   2. AUTO_LABEL (autoLabelBootstrap)`,
                `   3. OPENTELEMETRY (opentelemetry)`,
                `   4. PATCHES (patchBcrypt, patchJWT, patchStripe)`,
                `   5. ROUTES (routes/index)`,
...
exports.LoadOrderValidator = LoadOrderValidator;
LoadOrderValidator.loadedStages = new Set();
LoadOrderValidator.errors = [];
