...
| 06 | PATCH | `/preference-cards/:cardId` | Bearer | [06-update-preference-card.md](./06-update-preference-card.md) | [App Card Details](../../app-screens/03-preference-card-details.md), [Dashboard Card Mgmt](../../dashboard-screens/04-preference-card-management.md) |
...
| 06 | `/preference-cards/:cardId` | `PATCH` | Bearer | Done | Unified update/verify — owners update details; admins verify/reject. |
